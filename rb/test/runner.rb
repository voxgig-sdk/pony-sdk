...
module PonyTestRunner
  ...
  def self.env_override(m)
    live = getenv("PONY_TEST_LIVE")
    override = getenv("PONY_TEST_OVERRIDE")
    ...
    explain = getenv("PONY_TEST_EXPLAIN")
    m["PONY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
