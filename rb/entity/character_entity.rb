...
class CharacterEntity
  ...
  # @return [Character, Hash] the loaded Character; raises PonyError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Character>, Array] the matching Character items; raises PonyError on failure
