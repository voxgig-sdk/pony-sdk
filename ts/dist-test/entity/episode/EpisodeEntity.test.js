...
(0, node_test_1.describe)('EpisodeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set PONY_TEST_EPISODE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['episode01', 'episode02', 'episode03', 'by_season01', 'by_season02', 'by_season03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['PONY_TEST_EPISODE_ENTID'];
    ...
    idmap = env['PONY_TEST_EPISODE_ENTID'];
