...
(0, node_test_1.describe)('KindDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-kind', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-kind', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-kind', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-kind', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PONY_TEST_KIND_ENTID'];
...
//# sourceMappingURL=KindDirect.test.js.map