...
(0, node_test_1.describe)('ComicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-comic', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-comic', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-comic', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-comic', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PonySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['PONY_TEST_COMIC_ENTID'];
...
//# sourceMappingURL=ComicDirect.test.js.map