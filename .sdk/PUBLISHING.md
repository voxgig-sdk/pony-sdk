...
|---|---|---|
| `ts/` | @voxgig-sdk/pony-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/pony-sdk \
      --repository voxgig-sdk/pony-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/pony-sdk` shows it, and
`npm trust revoke @voxgig-sdk/pony-sdk --id=<id>` removes it.
