...
class PonyCacheFeature extends PonyBaseFeature
{
    ...
    private function _through(PonyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
