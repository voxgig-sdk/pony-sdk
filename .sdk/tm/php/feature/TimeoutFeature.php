...
class PonyTimeoutFeature extends PonyBaseFeature
{
    ...
    private function _with_timeout(PonyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PonyContext $_ctx, float $ms): void
    {
        $client = $this->client;
