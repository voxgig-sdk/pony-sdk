...
class PonyRatelimitFeature extends PonyBaseFeature
{
    ...
    private function _acquire(PonyContext $ctx): void
    {
    ...
    private function _track(PonyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
