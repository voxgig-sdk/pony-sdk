...
class PonyNetsimFeature extends PonyBaseFeature
{
    ...
    private function _simulate(PonyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PonyContext $ctx, array $applied): void
    {
        $client = $this->client;
