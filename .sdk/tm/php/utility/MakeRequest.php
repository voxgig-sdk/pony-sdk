...
// Pony SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PonyMakeRequest
{
    public static function call(PonyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PonyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PonyResponse($fetched);
        } else {
