...
class PonyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PonyTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = PonyTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = PonyTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
