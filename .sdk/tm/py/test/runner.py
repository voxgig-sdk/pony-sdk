...
class PonyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PonyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PonyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PonyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
