...
local KindEntity = {}
KindEntity.__index = KindEntity


function KindEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, KindEntity)
  self._name = "kind"
  self._client = client
...
function KindEntity:get_name()
  return self._name
end


function KindEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return KindEntity.new(self._client, opts)
end
...
function KindEntity:mark_deleted()
  self._deleted = true
end


function KindEntity:deleted()
  return true == self._deleted
end


function KindEntity:data_set(args)
  if args ~= nil then
...
function KindEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function KindEntity:match_set(args)
  if args ~= nil then
...
function KindEntity:stream(action, args, callopts)
...
function KindEntity:_run_op(ctx, post_done)
  local utility = self._utility
