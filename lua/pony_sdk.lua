...
PonySDK._make_feature = _make_feature


function PonySDK.new(options)
  local self = setmetatable({}, PonySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function PonySDK:get_utility()
  return Utility.copy(self._utility)
end


function PonySDK:get_root_ctx()
  return self._rootctx
end


function PonySDK:prepare(fetchargs)
...
function PonySDK:direct(fetchargs)
...
-- by passing it.
function PonySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function PonySDK:graphql(query, variables, ctrl)
...
function PonySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
