...
-- data to return.
local TEST_SEED = '{ entity = { ["character"] = { ["test01"] = { id = "test01" } }, ["comic"] = { ["test01"] = { id = "test01" } }, ["episode"] = { ["test01"] = { id = "test01" } }, ["image"] = { ["test01"] = { id = "test01" } }, ["kind"] = { ["test01"] = { id = "test01" } }, ["song"] = { ["test01"] = { id = "test01" } } } }'
