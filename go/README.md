...
The Golang SDK for the Pony API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/pony-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/pony-sdk=../path/to/github.com/voxgig-sdk/pony-sdk
```
...
```
github.com/voxgig-sdk/pony-sdk/
...
The root package (`github.com/voxgig-sdk/pony-sdk`) re-exports everything needed
