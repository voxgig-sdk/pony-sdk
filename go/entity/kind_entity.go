...
import (
	...
	vs "github.com/voxgig-sdk/pony-sdk/go/utility/struct"
)
...
func NewKindEntity(client *core.PonySDK, entopts map[string]any) *KindEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KindEntity) GetName() string { return e.name }
...
func (e *KindEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KindEntity) Deleted() bool {
	return e.deleted
}


func (e *KindEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKindEntity(e.client, opts)
}

func (e *KindEntity) Data(args ...any) any {
...
func (e *KindEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Kind; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KindEntity) DataTyped(data ...Kind) Kind {
	if len(data) > 0 {
		return typedFrom[Kind](e.Data(asMap(data[0])))
	}
	return typedFrom[Kind](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Kind (all fields
// optional at the wire level).
func (e *KindEntity) MatchTyped(match ...Kind) Kind {
	if len(match) > 0 {
		return typedFrom[Kind](e.Match(asMap(match[0])))
	}
	return typedFrom[Kind](e.Match())
}
...
func (e *KindEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KindEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KindLoadMatch and returns an Kind. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *KindEntity) LoadTyped(reqmatch KindLoadMatch, ctrl map[string]any) (Kind, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Kind{}, err
	}
	return typedFrom[Kind](res), nil
}




func (e *KindEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// KindListMatch and returns []Kind. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *KindEntity) ListTyped(reqmatch KindListMatch, ctrl map[string]any) ([]Kind, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Kind](res), nil
}



func (e *KindEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *KindEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *KindEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KindEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
