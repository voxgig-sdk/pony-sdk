...
const testSeed = `map[string]any{"entity": map[string]any{"character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "comic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "kind": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "song": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
