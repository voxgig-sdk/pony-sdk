...
class PonyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PonySDK/1.0)';
    ...
    public static function call(PonyContext $ctx, string $fullurl, array $fetchdef): array
    {
