...
// Pony SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PonySDK::test)
...
{
    private const SDK_CLASS = 'PonySDK';
    ...
    private const SDK_BASE = 'pony_sdk';
