...
class PonyTestRunner
{
    ...
    {
        $live = self::getenv('PONY_TEST_LIVE');
        $override = self::getenv('PONY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PONY_TEST_EXPLAIN');
...
class_alias('PonyTestRunner', 'Runner');
class_alias('PonyHelpers', 'Helpers');
