...
// Pony SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PonyTestFeature extends PonyBaseFeature
{
    ...
    public function init(PonyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PonyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PonyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PonyContext $ctx, $op, $args): array
    {
