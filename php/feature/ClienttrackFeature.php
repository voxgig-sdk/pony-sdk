...
class PonyClienttrackFeature extends PonyBaseFeature
{
    ...
    public function PostConstruct(PonyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pony-SDK';
