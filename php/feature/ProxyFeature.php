...
class PonyProxyFeature extends PonyBaseFeature
{
    ...
    public function init(PonyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PonyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
