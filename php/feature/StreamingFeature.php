...
class PonyStreamingFeature extends PonyBaseFeature
{
    ...
    private function _iterate(PonyResult $result): \Generator
    {
    ...
    private function _streamable(PonyContext $ctx): bool
    {
