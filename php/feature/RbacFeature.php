...
class PonyRbacFeature extends PonyBaseFeature
{
    ...
    private function _required(PonyContext $ctx): ?string
    {
    ...
    private function _reject(PonyContext $ctx, string $required): void
    {
    ...
    private function _track(PonyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
