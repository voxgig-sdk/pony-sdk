...
class ComicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ComicEntity($this->_client, $opts);
    }

    /**
     * @param Comic|array $args Comic data (assoc-array) to store.
     */
    ...
    /**
     * @return Comic|array The current Comic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Comic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Comic fields).
     */
     ...
     * Load a single Comic.
     *
     * @param ComicLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComicLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Comic|array The loaded Comic as an assoc-array at the
    ...
    /**
     * List Comic items matching the given filter.
     *
     * @param ComicListMatch|array|null $reqmatch Match filter (any subset
     *   of Comic fields) as an assoc-array; ComicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Comic[]|array A list of Comic items as assoc-arrays at
