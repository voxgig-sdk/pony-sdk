# Pony SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PonySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PonySDK(...) and PonySDK.test(...) become
#      PonySDK.test({"entity": {...}}) seeding one mock record (id "test01")
