...
from pony_sdk.core.control import PonyControl
...
from pony_sdk.core.helpers import get_ctx_prop, to_map
...
class PonyContext:
    ...
    def make_error(self, code, msg):
        return PonyError(code, msg, self)
