...
from pony_sdk.utility import register

# Load features
from pony_sdk.feature.base_feature import PonyBaseFeature
from pony_sdk.features import _has_feature, _make_feature
...
class PonySDK:
    ...
    def get_utility(self):
        return PonyUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "PonySDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PonySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from pony_sdk.entity.character_entity import CharacterEntity
    ...
    def Comic(self, data=None) -> "ComicEntity":
        ...
        from pony_sdk.entity.comic_entity import ComicEntity
