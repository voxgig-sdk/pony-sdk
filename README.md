...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/pony` | `npm install @voxgig-sdk/pony` |
| Python | `voxgig-sdk-pony` | `pip install voxgig-sdk-pony` |
| PHP | `voxgig-sdk/pony` | `composer require voxgig-sdk/pony` |
| Golang | `github.com/voxgig-sdk/pony-sdk/go` | `go get github.com/voxgig-sdk/pony-sdk/go` |
| Ruby | `voxgig-sdk-pony` | `gem install voxgig-sdk-pony` |
| Lua | `voxgig-sdk-pony` | `luarocks install voxgig-sdk-pony` |
